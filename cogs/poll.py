...
EMOJI_ALPHABET = [u"\U0001F1E6", u"\U0001F1E7", u"\U0001F1E8", u"\U0001F1E9", 
                      u"\U0001F1EA", u"\U0001F1EB", u"\U0001F1EC", u"\U0001F1ED", 
                      u"\U0001F1EE", u"\U0001F1EF", u"\U0001F1F0", u"\U0001F1F1", 
                      u"\U0001F1F2", u"\U0001F1F3", u"\U0001F1F4", u"\U0001F1F5", 
                      u"\U0001F1F6", u"\U0001F1F7", u"\U0001F1F8", u"\U0001F1F9"]
...
async def poll(ctx, question, *args):
    ...
    embed = discord.Embed(colour=discord.Colour(0x972b67), description="```{}```**To vote, click on one or many emojis**".format(question)) #if single choice is implemented, correct this
    embed.set_author(name="{} created a poll with {} choices!".format(username,len(args)), icon_url=pfp)
